...
import com.route.newsappc39_g_sun_wed.ui.theme.textColor
...
fun CategoriesFragment(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize()) {
        Text(
            ...
            color = textColor, modifier = Modifier.padding(horizontal = 24.dp, vertical = 8.dp)
        )
...
fun CategoryCardPreview() {
    CategoryCard(category = Constants.categories.get(0), 0, rememberNavController())
}
// class -> Title + image + apiId + backgroundColor
